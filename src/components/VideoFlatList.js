...
export default class XFFlatList extends PureComponent {
    ...
    _renderEmptyView = () => (
        <View style={{
            ...
            <Image source={require('./../../assets/images/list_placeholder.png')} resizeMode={'contain'}
    ...
    _renderFooter = () => {
        ...
        return (
            <View style={{
                ...
                <Animated.Image source={require('./../../assets/images/i_loading.gif')} resizeMode={'contain'}
                                style={{width: 20, height: 20, marginRight: 5, transform: [{rotate: spin}]}}/>
                <Text>正在加载...</Text>
            </View>
        )
    };
        ...
        return (
            ...
            >
                <View style={{justifyContent: 'space-between'}}>
                    ...
                    <ImageBackground source={{uri: item.cover}} resizeMode={'cover'}
                        ...
                        <View style={{
                            ...
                            <Image source={require('./../../assets/images/i_play.png')} resizeMode={'contain'}
                        ...
                        <Text style={{
                            ...
                            color: '#fff',
                            padding: 10
                        }}>{this._formatVideoTime(item.length)}</Text>
                    </ImageBackground>
                    ...
                    <View style={{
                        ...
                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                            <Image source={{uri: item.topicImg}} resizeMode={'contain'}
                                   style={{width: 30, height: 30, borderRadius: 30, marginRight: 10}}/>
                            <Text style={{marginRight: 6}}>{item.topicName}</Text>
                        </View>
                        <View style={{flexDirection: 'row', alignItems: 'center'}}>
                            <Image source={require('./../../assets/images/i_reply.png')} resizeMode={'contain'}
