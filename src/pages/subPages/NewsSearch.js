            ...
            <View style={styles.container}>
                ...
                <View style={styles.headerContainer}>
                    <View style={styles.searchContainer}>
                        <Image style={styles.searchImg} source={require('./../../../assets/images/i_search_grey.png')}
                               resizeMode={'contain'}/>
                        <TextInput
                    ...
                    <TouchableOpacity style={{width: 55, alignItems: 'center'}} activeOpacity={1} onPress={() => {
                            ...
                            this.hotList.map((item, index) => {
                                ...
                                return (
                                    <View key={index} style={styles.hotListItem}>
                                        ...
                                        {
                                            !index && <Image style={styles.hotImg}
                                                             source={require('./../../../assets/images/i_hot.png')}
                                                             resizeMode={'contain'}/>
                                        }
                                    </View>
                                )
