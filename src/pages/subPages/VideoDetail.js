        ...
        return (
            <View style={styles.container} onLayout={this._onLayoutChange}>
                ...
                <View style={{flex: 1, backgroundColor: 'red'}}>
                    <ScrollView style={{backgroundColor: '#f8f8f8'}}>
                        ...
                        <View style={styles.vedioInfoContainer}>
                            ...
                            <View style={styles.infoTopContainer}>
                                ...
                                <TouchableOpacity activeOpacity={1} style={styles.infoRight} onPress={() => {
                                    !this.state.isVote && this._clickVote()
                                }}>
                                    <Image style={styles.infoZoveImg}
                                           source={ this.state.isVote ? require('./../../../assets/images/i_vote_red.png') : require('./../../../assets/images/i_vote_black.png')}
                                           resizeMode={'contain'}/>
                                    <Text
                                        style={[styles.infoZoveText, {color: this.state.isVote ? '#d81e06' : '#000'}]}>{this.state.voteCount}</Text>
                                </TouchableOpacity>
                            </View>

                            <View style={styles.vedioPlayContainer}>
                                <Image resizeMode={'contain'}
                                       source={require('./../../../assets/images/i_right_arrows.png')}
                            ...
                            <View style={styles.vedioUserContainer}>
                                ...
                                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                                    <Image resizeMode={'contain'} source={{uri: this.topicImg}}
                                           style={styles.vedioUserImg}/>
                    ...
                    <View style={{height: 50, backgroundColor: '#f8f8f8', flexDirection: 'row'}}>
